...
"" ""
PENS
"Total" 1.0 0 -7500403 true "" "ifelse (ticks > 0) [plot mean [score] of turtles with [not document? and active?]][plot 0]"
"profile-1" 1.0 0 -2674135 true "" "carefully [\nifelse (ticks > 0) [plot mean [score] of turtles with [not document? and active? and breed = profiles1]]\n[plot 0]] \n[plot 0]"
...
"" ""
PENS
"total" 1.0 0 -16777216 true "" "plot sum [score] of turtles with [not document? and active?]"
"profiles-1" 1.0 0 -2674135 true "" "carefully [\nif (ticks > 0) [plot sum [score] of turtles with [not document? and active? and breed = profiles1]]\n]\n[plot 0]"
